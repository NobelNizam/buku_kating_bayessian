...
if menu == "Kesekjenan":
    def kesekjenan():
        gambar_urls = [
            ...
            "https://drive.google.com/uc?export=view&id=1mFNePDj3QNbftyRODlZ9e6iajLfMux7g_", #Kak hartiti
    ...
    def baleg():
        gambar_urls = [
            "https://drive.google.com/uc?export=view&id=12T81LbN2wg3iRrEKTdv-5z4iKoTXmdok",
