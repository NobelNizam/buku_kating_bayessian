...
if menu == "Kesekjenan":
    ...
    def psda():
        gambar_urls = [
            ...
            "https://drive.google.com/uc?export=view&id=1tBo0l5pxH4N8o3rNk-Iupet4c12OATy_", #Bg Rafly (tidak)
            "https://drive.google.com/uc?export=view&id=1IK5LgWWslS7y9y5ekZqpgeeGFGENV-tx", #Kak Syalaisha
        ]
        data_list = [
            {   #1
